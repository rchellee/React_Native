    ...
    if (selectedCategory === "Training 101") {
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                openModal({
                  ...
                  description:
                    "Regular veterinary check-ups are crucial to detect and prevent health issues early. Ensure your pet visits the vet at least once a year for a comprehensive health check.",
                })
              }
            >
              <Image
      ...
      return (
        <>
          ...
          >
            <Text style={styles.blogTitle}>
              How to Soften Dry Cat Food Into Wet Cat Food
            </Text>
            <Text style={styles.blogDesciption}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              openModal({
                ...
                description:
                  "Adding new cat toys into your home for your cat to discover instantly adds excitement to their day! Offering a variety of toys, from lasers to ribbons to toy mice, simulates having a variety of prey to hunt in the wild.\nHere are some ideas to make your fur baby even happier:\n1. Cat Furniture\n2. Scratching Posts\n3. Take them outside\n4. Play with people\n5. Animal Playmates",
              })
            }
          >
            <Text style={styles.blogTitle}>
          ...
          >
            <Text style={styles.blogTitle}>
              What is Chicken By-Product Meal in Dog & Cat Food?
            </Text>
            <Text style={styles.blogDesciption}>
      ...
      return (
        <>
          ...
          >
            ...
            <Text style={styles.articleDesciption}>
          ...
          >
            ...
            <Text style={styles.articleDesciption}>
              Posts by: Dr. Peter Kintzer, DVM, DACVIM
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.articleCard}
          ...
          >
            ...
            <Text style={styles.articleDesciption}>
              Reviewed on: Tuesday, April 5, 2016{" "}
            </Text>
            <Text style={styles.articleDesciption}>
              Posts by: Jason Carr, Former Pet Health Network Editor-in-Chief
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.articleCard}
          ...
          >
            ...
            <Text style={styles.articleDesciption}>
              Reviewed on: Wednesday, July 22, 2020{" "}
            </Text>
            <Text style={styles.articleDesciption}>
              Posts by: Jason Carr, Former Pet Health Network Editor-in-Chief
            </Text>
          ...
          >
            ...
            <Text style={styles.articleDesciption}>
              Reviewed on: Wednesday, September 23, 2015{" "}
            </Text>
            <Text style={styles.articleDesciption}>
        ...
        ListHeaderComponent={() => (
          <View style={styles.headerContainer}>
            <View style={styles.userInfo}>
              ...
              <Text className="mb-11"></Text>
            </View>
            <View style={styles.buttonsContainer}>
              {["Blog", "Training 101", "Medical", "Article"].map(
                (category) => (
                  <TouchableOpacity
                    key={category}
                    style={[
            ...
            <View style={styles.content}>
              ...
              >
                Welcome! Here you'll find informative content to help you become
                a better pet owner.
              </Text>
              {renderContent()}
            </View>
            ...
            <View style={styles.modalContent}>
              <ScrollView>
                {selectedImageData.image && (
                  <Image
                    source={selectedImageData.image}
                    style={styles.modalImage}
                    resizeMode="cover"
                  />
                )}
                <Text
                  style={[styles.modalTitle, { fontFamily: "Poppins-Bold" }]}
                >
